...
function Home() {
  ...
  return (
    <>
      ...
      <div>
        {/* <div className="bg-white rounded-3xl shadow-xl full my-5 mx-2 p-2 px-2 py-3 flex justify-center">
          <Row gutter={10} align="center">
            ...
            <Col lg={8} sm={24}>
              <div className="flex justify-center gap-4">
                <button
                  className="py-3 px-10 rounded-full bg-purple-600 hover:bg-purple-600 hover:duration-300 hover:shadow-xl text-white"
                  onClick={() => getBuses()}
                >
                  Search
                </button>
