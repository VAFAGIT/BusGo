    ...
    >
      <Form layout="vertical" onFinish={onFinish} initialValues={selectedBus}>
        <Row gutter={[10, 10]}>
          <Col lg={24} xs={24}>
            <Form.Item label="Bus Name" name="name">
              <input
                type="text"
                className="block border border-amber-500 w-full p-3 rounded-lg mb-4"
              />
            </Form.Item>
          </Col>
          <Col lg={12} xs={24}>
          ...
          <Col lg={12} xs={24}>
            <Form.Item label="From" name="from">
              <select className="block border border-amber-500 w-full p-3 rounded-lg mb-4">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="btn btn-primary bg-amber-600 hover:bg-amber-800"
          >
            Save
          </button>
        </div>
